extends Camera2D
#Minor changes made, sourced from this github:
#https://github.com/nthana/Camera2DSmoothDrag

const DRAG_MODE = 1
const PRECISE_MODE = 2
const IGNORE_MODE = 3
var CameraMode = PRECISE_MODE
export var drag_mode_H = 1
export var drag_mode_V = 1
...
func _on_Player_player_moves():
	#print("HELLO")
	notify_character_position(get_parent().get_node("Player").position)
